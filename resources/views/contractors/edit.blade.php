<x-app-layout>
    ...
    <div class="py-12" x-data='{ 
        ...
        is_jst: {{ old("is_jst", $contractor->is_jst ?? false) ? "true" : "false" }}
    }'>
                    ...
                    <form method="POST" action="{{ route('contractors.update', $contractor) }}">
                        ...
                        <div class="mt-8 border-t border-gray-200 pt-6">
                            <label for="show_recipient_jst" class="inline-flex items-center gap-3">
                                <input id="show_recipient_jst" type="checkbox" x-model="is_jst" name="is_jst" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ old('is_jst', $contractor->is_jst) ? 'checked' : '' }}>
                        ...
                        <div class="mt-4 border-t border-gray-200 pt-6" x-show="is_jst" x-transition>
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="recipient_nip" class="block mt-1 w-full" type="text" name="recipient_nip" :value="old('recipient_nip', $contractor->recipient_nip)" />
                            </div>

                            <div class="mt-4">
                                <x-input-label for="recipient_name" :value="'Nazwa Odbiorcy / Jednostki'" />
                                <x-text-input id="recipient_name" class="block mt-1 w-full" type="text" name="recipient_name" :value="old('recipient_name', $contractor->recipient_name)" />
                            </div>

                            <div class="grid grid-cols-3 gap-4 mt-4">
                                <div class="col-span-1">
                                    <x-input-label for="recipient_street" :value="'Ulica Odbiorcy'" />
                                    <x-text-input id="recipient_street" class="block mt-1 w-full" type="text" name="recipient_street" :value="old('recipient_street', $contractor->recipient_street)" />
                                </div>
                                <div>
                                    <x-input-label for="recipient_building" :value="'Nr domu Odbiorcy'" />
                                    <x-text-input id="recipient_building" class="block mt-1 w-full" type="text" name="recipient_building" :value="old('recipient_building', $contractor->recipient_building)" />
                                </div>
                                <div>
                                    <x-input-label for="recipient_apartment" :value="'Nr lokalu Odbiorcy'" />
                                    <x-text-input id="recipient_apartment" class="block mt-1 w-full" type="text" name="recipient_apartment" :value="old('recipient_apartment', $contractor->recipient_apartment)" />
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                <div>
                                    ...
                                    <x-text-input id="recipient_postal_code" class="block mt-1 w-full" type="text" name="recipient_postal_code" :value="old('recipient_postal_code', $contractor->recipient_postal_code)" />
                                </div>
                                <div>
                                    <x-input-label for="recipient_city" :value="'Miasto Odbiorcy'" />
                                    <x-text-input id="recipient_city" class="block mt-1 w-full" type="text" name="recipient_city" :value="old('recipient_city', $contractor->recipient_city)" />
                                </div>
                            </div>
                        </div>
