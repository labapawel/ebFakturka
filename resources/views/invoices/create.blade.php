                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="grid grid-cols-4 gap-4 mb-6">
                            <div>
                                ...
                                <x-text-input id="number" class="block mt-1 w-full" type="text" name="number" value="{{ $suggestedNumber }}" required />
                        ...
                        <div class="grid grid-cols-3 gap-4 mb-6">
                         ...
                         <div class="mb-6">
                            ...
                            <textarea id="description" name="description" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm h-24">{{ old('description') }}</textarea>
                            ...
                            <tbody>
                                <template x-for="(item, index) in items" :key="index">
                                    <tr class="border-t">
                                        ...
                                        @else
                                            <!-- Hidden input for VAT rate 0 when exempt -->
    ...
    <script>
        function invoiceForm() {
            return {
                ...
                isJst: false,
                recipient_data: {
                    name: '', nip: '', street: '', building: '', apartment: '', postal_code: '', city: ''
                },
