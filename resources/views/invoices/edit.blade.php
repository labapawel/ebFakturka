                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="grid grid-cols-4 gap-4 mb-6">
                            ...
                            <div>
                                <x-input-label for="sale_date" :value="__('Data sprzeda¿y')" />
                            ...
                            <div>
                                <x-input-label for="due_date" :value="__('Termin p³atnoœci')" />
                        ...
                        <div class="grid grid-cols-3 gap-4 mb-6">
                         ...
                         <div class="mb-6">
                            <x-input-label for="payment_method" :value="__('Metoda p³atnoœci')" />
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 text-gray-900 overflow-x-auto">
                        <table class="min-w-full">
                            <thead>
                                <tr>
                                    <th class="text-left py-2">Produkt / Us³uga</th>
                                    ...
                                    <th class="text-right py-2 w-32">Wartoœæ Netto</th>
                                    @endif
                                    <th class="text-right py-2 w-32">Wartoœæ @if(!$isVatExempt) Brutto @else @endif</th>
